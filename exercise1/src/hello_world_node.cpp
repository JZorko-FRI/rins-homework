...
{
	//Initialize the ROS system (the client library). We call this once at the begining of our programs. 
	...
	ros::NodeHandle nh; //Creating this object registers the node with the ROS master
